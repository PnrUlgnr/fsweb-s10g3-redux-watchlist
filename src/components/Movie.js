...
export default function Movie(props) {
  const movies = useSelector((state) => state.movieReducer.movies); // git statem den combine ettiğim statemden git moviereducer ı al onun içinden movies i al movies i ver :)
